...
export default function JasaPptPage() {
  ...
  const services = [
    { id: 1, title: "Business Pitch", type: "Corporate", icon: "🚀", theme: "blue", price: 100000, desc: "Slide presentasi untuk kebutuhan pitching ide bisnis ke calon partner atau klien." },
    { id: 2, title: "Investor Deck", type: "Funding", icon: "💰", theme: "emerald", price: 250000, desc: "Desain slide premium dengan visualisasi data yang meyakinkan bagi calon investor." },
    { id: 3, title: "Webinar Material", type: "Education", icon: "👨‍🏫", theme: "cyan", price: 150000, desc: "Slide edukatif yang bersih dan menarik untuk pembicara seminar atau webinar." },
    { id: 4, title: "Company Profile", type: "Branding", icon: "🏢", theme: "brand", price: 200000, desc: "Presentasi profil perusahaan elegan untuk meningkatkan kredibilitas di depan klien.", isFeatured: true },
    { id: 5, title: "Academic PPT", type: "Education", icon: "🎓", theme: "indigo", price: 75000, desc: "Desain slide rapi dan terstruktur untuk presentasi skripsi, tesis, atau riset." },
    { id: 6, title: "Portfolio Deck", type: "Personal", icon: "📁", theme: "orange", price: 125000, desc: "Slide showcase karya pribadi atau instansi dengan tampilan yang estetik." },
    { id: 7, title: "Infographic PPT", type: "Data", icon: "📉", theme: "teal", price: 150000, desc: "Fokus pada visualisasi data dan grafik yang mudah dipahami dalam satu slide." },
    { id: 8, title: "Training Material", type: "Workshop", icon: "📹", theme: "rose", price: 175000, desc: "Slide pelatihan (Training) atau Workshop yang dirancang interaktif." },
    { id: 9, title: "Standard Deck", type: "Daily", icon: "📄", theme: "slate", price: 75000, desc: "Layanan desain slide standar untuk kebutuhan presentasi harian yang efisien." },
    { id: 10, title: "Custom PPT", type: "Idea", icon: "⚙️", theme: "slate", price: "Flexible", desc: "Punya permintaan khusus atau gaya visual unik? Mari kita diskusikan." }
  ];

  const getIconStyle = (themeName, isFeatured) => {
    if (isFeatured) return "bg-white text-emerald-600 shadow-md";
  ...
  return (
    <main className="bg-white min-h-screen font-['Plus_Jakarta_Sans',sans-serif] selection:bg-emerald-500 selection:text-white">

      {/* 1. BACKGROUND GRID KOTAK-KOTAK */}
      ...
      {/* AMBIENT GLOW EMERALD DI TENGAH */}
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-3xl h-[600px] bg-emerald-500/10 blur-[120px] rounded-full pointer-events-none z-0"></div>
        ...
        <div className="max-w-5xl mx-auto text-center relative z-10">
          ...
          >
            ...
            <span className="relative inline-block mt-2 md:mt-4">
              <span className="text-transparent" style={{ WebkitTextStroke: '2px #0f172a' }}>YANG</span>
              ...
              <motion.span 
                ...
                className="absolute -bottom-2 md:-bottom-4 left-0 w-full h-[4px] md:h-[8px] bg-gradient-to-r from-emerald-600 to-cyan-500 origin-left"
              ></motion.span>
            </span>
          </motion.h1>
          ...
          >
            Tingkatkan kredibilitas bisnis Anda dengan desain slide presentasi yang estetik, terstruktur, dan berorientasi pada hasil.
          </motion.p>
        </div>
      </section>
            ...
            {services.map((svc, i) => {
              ...
              if (isCustom) {
                return (
                  ...
                  >
                    <div className="absolute inset-0 bg-[radial-gradient(circle_at_right,rgba(16,185,129,0.15),transparent_50%)] opacity-0 group-hover:opacity-100 transition-opacity duration-700"></div>
                    <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-emerald-600 via-teal-500 to-cyan-500 scale-x-0 group-hover:scale-x-100 transition-transform origin-left duration-700 z-10"></div>

                    <div className="relative z-10 flex flex-col md:flex-row items-start md:items-center gap-6 md:gap-8 flex-1">
                      <div className="w-16 h-16 md:w-20 md:h-20 shrink-0 bg-white/5 border border-white/10 text-emerald-400 rounded-[1.5rem] flex items-center justify-center text-4xl shadow-xl group-hover:scale-110 group-hover:rotate-12 transition-transform duration-500">
                        {svc.icon}
                      </div>
                      <div>
                        <span className="inline-block px-3 py-1 bg-emerald-500/10 border border-emerald-500/20 text-emerald-400 text-[10px] font-black uppercase tracking-widest rounded-full mb-3">
                          💡 Format Lain?
                        </span>
                        <h3 className="text-3xl md:text-4xl font-[900] text-white tracking-tight mb-2 group-hover:text-emerald-400 transition-colors">
                          {svc.title}
                        </h3>
                    ...
                    <div className="relative z-10 shrink-0 w-full md:w-auto flex flex-col items-start md:items-end border-t border-slate-800 md:border-t-0 pt-6 md:pt-0">
                      ...
                      <button className="w-full md:w-auto px-8 py-4 bg-emerald-600 text-white font-bold rounded-xl flex items-center justify-center gap-3 group-hover:bg-white group-hover:text-slate-900 transition-all shadow-[0_10px_20px_rgba(16,185,129,0.3)]">
                        Mulai Diskusi
              ...
              return (
                ...
                >
                  <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-emerald-500 to-cyan-500 scale-x-0 group-hover:scale-x-100 transition-transform origin-left duration-500"></div>
                  ...
                  <div className="flex-1">
                    <h3 className={`text-2xl font-[900] tracking-tight mb-3 group-hover:text-emerald-600 transition-colors ${textTitle}`}>
                      {svc.title}
                    </h3>
                  ...
                  <div className={`mt-8 pt-6 border-t flex items-end justify-between ${borderDivider}`}>
                    ...
                    <div className={`w-10 h-10 rounded-full flex items-center justify-center transition-colors ${isDark ? 'bg-white/10 text-white group-hover:bg-emerald-600' : 'bg-slate-50 text-slate-400 group-hover:bg-emerald-500 group-hover:text-white'}`}>
      ...
      <AnimatePresence>
        {isModalOpen && (
          <div className="fixed inset-0 z-[300] flex items-center justify-center px-4">
            ...
            >
              <div className="absolute top-0 left-0 w-full h-2 bg-gradient-to-r from-emerald-600 to-cyan-500"></div>

              <div className="flex justify-between items-center mb-6 pb-6 border-b border-slate-100 shrink-0">
                <div>
                  <span className="inline-block px-3 py-1 bg-emerald-50 text-emerald-600 text-[9px] font-black uppercase tracking-widest rounded-full mb-3">
                    Detail Pesanan
                  </span>
                  <h3 className="text-3xl font-[900] text-slate-900 tracking-tight leading-none uppercase italic">Slide <span className="text-transparent" style={{ WebkitTextStroke: '1px #0f172a' }}>Brief.</span></h3>
                </div>
              ...
              <div className="overflow-y-auto overflow-x-hidden pr-2 custom-scrollbar">
                <div className="p-4 bg-slate-50 border border-slate-100 rounded-2xl mb-6 flex items-center justify-between">
                  <div>
                    <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-1">Target Format</p>
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  <div>
                    ...
                    <input type="text" required placeholder="Contoh: Budi (PT Maju Jaya)" 
                      value={formData.name} onChange={(e) => setFormData({...formData, name: e.target.value})}
                      className="w-full px-5 py-4 bg-white border-2 border-slate-200 rounded-2xl text-sm font-bold text-slate-900 placeholder:text-slate-400 focus:outline-none focus:border-emerald-500 focus:ring-4 focus:ring-emerald-500/10 transition-all"
                    />
                  </div>

                  <div>
                    <label className="block text-[10px] font-black text-slate-500 uppercase tracking-widest mb-2 ml-1">Total Slide & Kebutuhan <span className="text-red-500">*</span></label>
                    <textarea required rows="3" placeholder="Misal: Butuh 15 slide, gaya modern minimalis, untuk materi edukasi..." 
                      value={formData.desc} onChange={(e) => setFormData({...formData, desc: e.target.value})}
                      className="w-full px-5 py-4 bg-white border-2 border-slate-200 rounded-2xl text-sm font-bold text-slate-900 placeholder:text-slate-400 focus:outline-none focus:border-emerald-500 focus:ring-4 focus:ring-emerald-500/10 transition-all resize-none"
                    ></textarea>
                  </div>

                  <div>
                    <label className="block text-[10px] font-black text-emerald-600 uppercase tracking-widest mb-2 ml-1">Budget Allocation (Rp) <span className="text-red-500">*</span></label>
                    <div className="relative">
                      ...
                      <input type="number" required min="75000" placeholder="Minimal 75000"
                        ...
                        className={`w-full pl-14 pr-5 py-4 bg-slate-50 border-2 rounded-2xl text-lg font-black text-slate-900 focus:outline-none transition-all
                          ${errorPrice ? 'border-red-500 focus:border-red-500 focus:ring-4 focus:ring-red-500/10' : 'border-slate-200 focus:border-emerald-500 focus:ring-4 focus:ring-emerald-500/10 hover:border-slate-300'}
                        `}
                      />
                    </div>
                  ...
                  <div className="pt-2 pb-1">
                    <button type="submit" className="w-full py-5 bg-slate-950 text-white text-xs font-black uppercase tracking-widest rounded-2xl hover:bg-emerald-600 hover:shadow-[0_20px_40px_rgba(16,185,129,0.3)] hover:-translate-y-1 transition-all duration-300 flex justify-center items-center gap-2 group">
